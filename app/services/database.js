...
module.exports.getConceptNames = require("./database/getConceptNames")
module.exports.getTrending = require("./database/getTrending")
module.exports.mapTrending = require("./database/mapTrending")
